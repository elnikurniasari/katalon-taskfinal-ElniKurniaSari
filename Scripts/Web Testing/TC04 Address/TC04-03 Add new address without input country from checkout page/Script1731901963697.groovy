...
WebUI.click(findTestObject('Web Testing/Shopping cart/Button_Add New Address'))
...
WebUI.verifyElementVisible(findTestObject('Web Testing/Checkout/Address/Add address/Error Message_Please provide a country'))
